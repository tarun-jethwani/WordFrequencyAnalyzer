...
"""
TEXT1 = (
    "##@Apple&^*_Mango08%$Orange#$%Mango;guava::Guava$Banana#Mango"
    "?/Orange*apple(Banana:"
)
TEXT2 = (
    "##@Rose&^*_Tulip08%$sunflower#*&tulip$%lily;tulip::Rose$#>"
...
NON_ALPHA_NON_LOWER_CASE_PAIRS = [
    ("oRAnge", 8),
    ("Guava", 6),
    ("&%rose", 4),
    ("%$#lily*", 2),
...
URL_HIGHEST_FREQUENCY = (
    "/calculate_highest_frequency/The%20sun%20shines" "%20over%20the%20lake/"
)
URL_FREQUENCY_FOR_WORD = (
    "/calculate_frequency_for_word/The%20sun%20shines"
    "%20over%20the%20lake/over"
)
URL_MOST_FREQUENT_N_WORDS = (
    "/calculate_most_frequent_n_words/The%20sun"
...
URL_ERROR_MOST_FREQUENT_WORDS = (
    "/calculate_most_frequent_n_words/" "The sun shines over the lake/the"
)
...
TEST_DATA_1 = {
    "test_case_1": (
        [(TEXT1, FREQUENCY_1), (TEXT2, FREQUENCY_2)],
        "test_highest_frequency",
    ),
    "test_case_2": (
        [(TEXT1, WORD_1, FREQUENCY_GUAVA), (TEXT2, WORD_2, FREQUENCY_JASMIN)],
        "test_word_frequency",
    ),
    "test_case_3": (
        [(TEXT1, N_VALUE1, FRUITS_ORDER), (TEXT2, N_VALUE2, FLOWER_ORDER)],
        "test_most_frequent_n_words",
    ),
    "test_case_4": (
        [(DUMMY_FLOAT, TEXT_TYPE_ERROR), (DUMMY_INT, TEXT_TYPE_ERROR)],
        "test_type_error_highest_frequency",
    ),
    "test_case_5": (
        [(EMPTY_TEXT_1, TEXT_VALUE_ERROR), (EMPTY_TEXT_2, TEXT_VALUE_ERROR)],
        "test_value_error_highest_frequency",
    ),
    "test_case_6": (
        [
            (DUMMY_FLOAT, WORD_1, TEXT_TYPE_ERROR),
    ...
    "test_case_7": (
        [
            (TEXT1, DUMMY_FLOAT, WORD_TYPE_ERROR),
    ...
    "test_case_8": (
        [
            (EMPTY_TEXT_1, WORD_1, TEXT_VALUE_ERROR),
